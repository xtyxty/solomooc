...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Quartz���ʽ������(wjw465150@gmail.com)");
        setResizable(false);

        jTabbedPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "����,ʱ��"));
    ...
    private void jButton_ParseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ParseActionPerformed
        try {
            ...
            //ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "����Cron���ʽ��������:" + ex);
        }
